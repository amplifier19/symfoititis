...
export const useModal = () => {
  ...
  const activateUniAddModal = () => {
    modal.value = {
      ...
      inputs: [
        ...
        { label: 'Alt name', name: 'uni_alt_name', value: '', type: 'text', required: true }
      ],
  ...
  const activateUniEditModal = (uni: University) => {
    modal.value = {
      ...
      buttons: [{ text: 'Edit', classes: ['pf-v5-c-button', 'pf-m-primary'], type: 'submit' }]
    }
    modalStore.setDisplay(true)
  }
  ...
  const activateDepAddModal = () => {
    modal.value = {
      ...
      inputs: [
        ...
        { label: 'Alt name', name: 'dep_alt_name', value: '', type: 'text', required: true }
      ],
      selects: [
        {
          name: 'uni_id',
  ...
  const activateCourseAddModal = (dep_id: number) => {
    modal.value = {
      ...
      inputs: [
        ...
        { label: 'Display name', name: 'c_display_name', value: '', type: 'text', required: true },
        { label: 'Semester', name: 'semester', value: '', type: 'number', required: true },
        { label: 'Description', name: 'description', value: '', type: 'text', required: false }
      ],
      buttons: [{ text: 'Add', classes: ['pf-v5-c-button', 'pf-m-primary'] }]
    }
    modalStore.setDisplay(true)
   ...
   * File Modal
   */
  const activateFileRemoveModal = (data: { c_id: number; filename: string }) => {
    modal.value = {
      title: 'Remove Note',
      icon: 'fa fa-trash',
      event: 'delete-file',
