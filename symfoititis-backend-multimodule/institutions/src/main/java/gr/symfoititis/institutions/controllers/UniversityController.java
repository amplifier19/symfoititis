...
public class UniversityController {
    ...
    ResponseEntity<Response> university (@RequestHeader("X-Role") String role, @PathVariable(value="uni_id", required=false) Integer uni_id) {
        isAdmin(role);
        University university = universitiesService.getUniversity(uni_id);
        return ResponseEntity.ok(new Response(200, university));
    }
    @PostMapping("/university")
    ResponseEntity<Response> addUniversity (@RequestHeader("X-Role") String role, @RequestBody University university) {
        isAdmin(role);
    ...
    ResponseEntity<Response> updateUniversity (@RequestHeader("X-Role") String role, @RequestBody University university) {
        isAdmin(role);
    ...
    ResponseEntity<Response> deleteUniversity (@RequestHeader("X-Role") String role, @PathVariable(value="uni_id", required=true) Integer uni_id) {
        isAdmin(role);
