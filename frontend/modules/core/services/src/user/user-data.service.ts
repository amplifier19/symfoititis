...
import { AuthAdapterService, DepartmentsApiService, UniversitiesApiService } from "@symfoititis-frontend-monorepo/core/services"
...
export const useUserDataService = () => {
  ...
  const universitiesApiService = UniversitiesApiService.getUniversitiesApiFactory()
  const departmentsApiService = DepartmentsApiService.getDepartmentsApiFactory()
  ...
  const loadUserProfile = () => {
    ...
    authAdapterService.loadUserProfile()
