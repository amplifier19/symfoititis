    ...
    <nav>
      <ul class="nav-items-container">
        <RouterLink :to="{ name: 'courses' }">
          <Sidebox
            v-if="props.selected == 1 || props.selected == 2"
            :content="getHistorySize('notes_history')"
            id="left-sidebox"
          />
          <li ref="notesBtn" class="nav-item lg-font md-fw">Σημειώσεις</li>
        </RouterLink>
        <RouterLink :to="{ name: 'tutoring' }">
          <li ref="tutoringBtn" class="nav-item lg-font md-fw">Ιδιαίτερα</li>
          <Sidebox
            v-if="props.selected == 0 || props.selected == 2"
            :content="getHistorySize('bookings_history')"
            id="right-sidebox"
          />
        </RouterLink>
      </ul>
